...
public class Manager {
    /**
     * The function to run the whole program
     */
        ...
        while (!inTheApp) {
            ...
            if (choice == 1) {
                ...
                while (!correctData) {
                    ...
                    User user = new User();
//                    UserAccount Account = user.login(username , password , buyerOrAdmin , myWeb.getDatabase());
//                    myWeb.setTheUser(Account);
...
//                                                    validOrderChoice = true;
                                                    ...
                                                    System.out.println("\n\nYour order :");
                                                    myCart.viewItems();
                                                    System.out.println("\n\nEnter '1' to confirm your order ( you can not cancel it after it starts to be shipped ) .. \n" +
...
//                                String OTPin;
                                while (!matchedOTP) {
                                    ...
                                    String sentOTP = myWeb.sendOTP_mail(email);
//                                    System.out.print("\nPlease , enter the OTP sent to you : ");
//                                    String OTPin = input.nextLine();
                                    if (myWeb.checkOTP(sentOTP)) {
...
//                                        myWeb.getDatabase().addBuyer(newUser);
//                                        myWeb.getUsers().add(newUser);
